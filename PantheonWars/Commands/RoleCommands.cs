    ...
    IPlayerReligionDataManager playerReligionDataManager)
{
    ...
    public void RegisterCommands()
    {
        ...
        if (religionCmd == null)
        {
            _sapi.Logger.Error("[PantheonWars] Religion command not found, cannot register role commands");
            return;
        }
        ...
        _sapi.Logger.Notification("[PantheonWars] Role commands registered");
    }
