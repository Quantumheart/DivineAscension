...
public class PlayerProgressionDataTests
{
    ...
    #region Computed FavorRank Tests

    [Fact]
    public void FavorRank_WithZeroFavor_ReturnsInitiate()
    {
        // Arrange
        var data = new PlayerProgressionData("player-123")
        {
        ...
        // Act
        var rank = data.FavorRank;

        // Assert
        Assert.Equal(FavorRank.Initiate, rank);
    }

    [Fact]
    public void FavorRank_With499Favor_ReturnsInitiate()
    {
        // Arrange
        var data = new PlayerProgressionData("player-123")
        {
            TotalFavorEarned = 499
        };
    ...
    [Fact]
    public void FavorRank_With500Favor_ReturnsDisciple()
    {
        // Arrange
        var data = new PlayerProgressionData("player-123")
        {
            TotalFavorEarned = 500
        };
    ...
    [Fact]
    public void FavorRank_With1999Favor_ReturnsDisciple()
    {
        // Arrange
        var data = new PlayerProgressionData("player-123")
        {
            TotalFavorEarned = 1999
        };
    ...
    [Fact]
    public void FavorRank_With2000Favor_ReturnsZealot()
    {
        // Arrange
        var data = new PlayerProgressionData("player-123")
        {
            TotalFavorEarned = 2000
        };
        ...
        // Assert
        Assert.Equal(FavorRank.Zealot, rank);
    }

    [Fact]
    public void FavorRank_With4999Favor_ReturnsZealot()
    {
        // Arrange
        var data = new PlayerProgressionData("player-123")
        {
            TotalFavorEarned = 4999
        };
    ...
    [Fact]
    public void FavorRank_With5000Favor_ReturnsChampion()
    {
        // Arrange
        var data = new PlayerProgressionData("player-123")
        {
            TotalFavorEarned = 5000
        };
        ...
        // Assert
        Assert.Equal(FavorRank.Champion, rank);
    }

    [Fact]
    public void FavorRank_With9999Favor_ReturnsChampion()
    {
        // Arrange
        var data = new PlayerProgressionData("player-123")
        {
            TotalFavorEarned = 9999
        };
    ...
    [Fact]
    public void FavorRank_With10000Favor_ReturnsAvatar()
    {
        // Arrange
        var data = new PlayerProgressionData("player-123")
        {
        ...
        // Assert
        Assert.Equal(FavorRank.Avatar, rank);
    }

    [Fact]
    public void FavorRank_With100000Favor_ReturnsAvatar()
    {
        // Arrange
        var data = new PlayerProgressionData("player-123")
        {
            TotalFavorEarned = 100000
        };
    ...
    [Fact]
    public void FavorRank_IsComputedDynamically()
    {
        // Arrange
        var data = new PlayerProgressionData("player-123")
        {
            TotalFavorEarned = 100
        };

        // Act & Assert - Initial rank
        Assert.Equal(FavorRank.Initiate, data.FavorRank);

        // Increase favor to Disciple threshold
        data.TotalFavorEarned = 500;
        Assert.Equal(FavorRank.Disciple, data.FavorRank);

        // Increase favor to Zealot threshold
        data.TotalFavorEarned = 2000;
        Assert.Equal(FavorRank.Zealot, data.FavorRank);

        // Increase favor to Champion threshold
        data.TotalFavorEarned = 5000;
        Assert.Equal(FavorRank.Champion, data.FavorRank);

        // Increase favor to Avatar threshold
        data.TotalFavorEarned = 10000;
        Assert.Equal(FavorRank.Avatar, data.FavorRank);
    }

    [Fact]
    public void AddFavor_UpdatesTotalFavorEarned()
    {
        // Arrange
        var data = new PlayerProgressionData("player-123");
        ...
        // Assert
        Assert.Equal(500, data.TotalFavorEarned);
        Assert.Equal(FavorRank.Disciple, data.FavorRank);
    }

    [Fact]
    public void AddFavor_MultipleAdditions_UpdatesRankCorrectly()
    {
        // Arrange
        var data = new PlayerProgressionData("player-123");
        ...
        data.AddFavor(300); // Total: 600
        Assert.Equal(FavorRank.Disciple, data.FavorRank);

        data.AddFavor(1500); // Total: 2100
        Assert.Equal(FavorRank.Zealot, data.FavorRank);

        data.AddFavor(3000); // Total: 5100
        Assert.Equal(FavorRank.Champion, data.FavorRank);

        data.AddFavor(5000); // Total: 10100
        Assert.Equal(FavorRank.Avatar, data.FavorRank);
    }
    ...
    public void ApplySwitchPenalty_ResetsFavorAndBlessings()
    {
        ...
        Assert.Equal(FavorRank.Zealot, data.FavorRank); // Computed from TotalFavorEarned
        Assert.Empty(data.UnlockedBlessings);
    }
