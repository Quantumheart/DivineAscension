...
public static class LocalizationKeys
{
    ...
    public const string UI_RELIGION_INVITES_QUOTE = "divineascension:ui.religion.invites.quote";
    public const string UI_RELIGION_INVITES_FROM = "divineascension:ui.religion.invites.from";
    ...
    public const string UI_RELIGION_ACTIVITY_INTRO = "divineascension:ui.religion.activity.intro";
    public const string UI_RELIGION_ACTIVITY_DAY_TODAY = "divineascension:ui.religion.activity.day.today";
    public const string UI_RELIGION_ACTIVITY_DAY_YESTERDAY = "divineascension:ui.religion.activity.day.yesterday";
    public const string UI_RELIGION_ACTIVITY_ENTRY_LINE = "divineascension:ui.religion.activity.entry.line";
    public const string UI_RELIGION_ACTIVITY_FOOTER_CLOSING = "divineascension:ui.religion.activity.footer.closing";
    ...
    public const string UI_CIVILIZATION_LEADERBOARD_BOARD_STANDING = "divineascension:ui.civilization.leaderboard.board.standing";
    public const string UI_CIVILIZATION_LEADERBOARD_BOARD_CONQUEST = "divineascension:ui.civilization.leaderboard.board.conquest";
    public const string UI_CIVILIZATION_LEADERBOARD_BOARD_ENDURANCE = "divineascension:ui.civilization.leaderboard.board.endurance";
    public const string UI_CIVILIZATION_LEADERBOARD_BOARD_DEEDS = "divineascension:ui.civilization.leaderboard.board.deeds";
    ...
    // Civilization chronicle (#369)
    public const string UI_CIVILIZATION_INFO_CHRONICLE_HEADING =
        "divineascension:ui.civilization.info.chronicle.heading";
    ...
    public const string CHRONICLE_RELIGION_JOINED = "divineascension:chronicle.religion_joined";
    public const string CHRONICLE_RELIGION_LEFT = "divineascension:chronicle.religion_left";
    public const string CHRONICLE_MILESTONE_FALLBACK = "divineascension:chronicle.milestone_fallback";
    public const string CHRONICLE_WAR_DECLARED = "divineascension:chronicle.war_declared";
    public const string CHRONICLE_WAR_RECEIVED = "divineascension:chronicle.war_received";
    public const string CHRONICLE_PEACE_SIGNED = "divineascension:chronicle.peace_signed";
